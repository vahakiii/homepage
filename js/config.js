...
var EMOJI_NAMES = {
    ...
    '⛵': 'Sailboat (Sailing, Boat, Wind, Yacht, Sea, Travel, Sail, Water)',
    ...
    '🎙️': 'Studio Microphone (Podcast, Broadcast, Record, Studio, Voice, Interview, Mic, On Air)',
    '🎚️': 'Level Slider (Gauge, Control, Slider, Settings, Adjustment)',
    '🎞️': 'Film (Movie, Camera, Old, Strip, Cinema)',
    '🎟️': 'Admission Tickets (Tickets, Event, Show, Concert, Entry, Pass, Stub, Entertainment)',
    ...
    '🎷': 'Saxophone (Music, Jazz, Sax, Instrument, Blues, Band, Reed, Concert)',
    '🎸': 'Guitar (Music, Instrument)',
    '🎹': 'Musical Keyboard (Piano, Keys, Music, Instrument, Melody, Synth, Organ, Play)',
    '🎺': 'Trumpet (Music, Brass, Jazz, Horn, Instrument, Band, Fanfare, Concert)',
    '🎻': 'Violin (Music, Strings, Orchestra, Classical, Instrument, Fiddle, Recital, Concert)',
    '🎼': 'Musical Score (Sheet Music, Composition, Notes, Staff, Song, Score, Compose, Music)',
    ...
    '🏍️': 'Motorcycle (Bike, Ride, Motorbike, Fast, Chopper, Two Wheeler, Travel, Road)',
    ...
    '🐂': 'Ox (Bull, Cattle, Farm, Strong, Livestock, Horns, Beast, Animal)',
    '🐄': 'Cow (Cattle, Farm, Dairy, Milk, Livestock, Grazing, Herd, Animal)',
    ...
    '🐠': 'Tropical Fish (Fish, Ocean, Reef, Colorful, Aquarium, Sea, Animal, Swim)',
    ...
    '🐮': 'Cow Face (Cow, Cattle, Farm, Dairy, Moo, Cute, Livestock, Animal)',
    ...
    '💭': 'Thought Balloon (Think, Idea, Daydream, Consider, Bubble, Wonder, Brainstorm, Inner Voice)',
    ...
    '📸': 'Camera with Flash (Photo, Snapshot, Share, Instagram, Capture, Picture, Social, Camera)',
    '📹': 'Video Camera (Record, Film, Movie, Camcorder, Capture, Media)',
    '📺': 'TV (Watch, Screen, Show, Entertainment, Remote)',
    '📻': 'Radio (Broadcast, FM, Listen, Music, Station, Audio, AM, Tuner)',
    ...
    '🗨️': 'Left Speech Bubble (Chat, Comment, Message, Talk, Conversation, Reply, Social, Quote)',
    '🗳️': 'Ballot Box (Voting, Election, Democracy, Civic Duty, Choice)',
    '🗺️': 'World Map (Location, Navigation, Travel, Exploration, Discovery)',
    '🗼': 'Tokyo Tower (Landmark, Japan, Travel, Observation, Red, City, Sightseeing, Tower)',
    ...
    '😷': 'Face with Medical Mask (Sick, Germs, Protection, Doctor, Flu, Health, PPE, Mask)',
    ...
    '🚂': 'Locomotive (Train, Steam, Railway, Engine, Vintage, Travel, Choo, Track)',
    ...
    '🚒': 'Fire Engine (Firetruck, Firefighter, Emergency, Rescue, Siren, Fire, Engine, Ladder Truck)',
    '🚓': 'Police Car (Cop, Patrol, Emergency, Law, Siren, Officer, Cruiser, Enforcement)',
    ...
    '🚜': 'Tractor (Farm, Agriculture, Field, Rural, Harvest, Vehicle, Farmer, Heavy)',
    '🚢': 'Ship (Boat, Cruise, Ocean, Travel, Sea, Vessel, Transport)',
    '🚤': 'Speedboat (Boat, Fast)',
    '🚦': 'Traffic Light (Signal, Stop, Go, Intersection, Red Light, Green, Road, Traffic)',
    ...
    '🛬': 'Airplane Arrival (Landing, Flight, Travel, Airport, Plane, Arrive, Touchdown, Incoming)',
    ...
    '🛶': 'Canoe (Paddle, Boat, Lake, River, Camping, Outdoor, Canoeing, Portage)',
    ...
    '🤒': 'Face with Thermometer (Fever, Sick, Ill, Temperature, Flu, Health, Unwell, Cold)',
    ...
    '🤕': 'Face with Head-Bandage (Injury, Hurt, Accident, First Aid, Pain, Health, Wound, Recover)',
    ...
    '🤳': 'Selfie (Photo, Phone, Social Media, Pose, Camera, Share, Portrait, Snap)',
    ...
    '🦅': 'Eagle (Bird, Freedom, Soar, Hunter, Bald Eagle, Wings, Animal, Sky)',
    '🦆': 'Duck (Bird, Pond, Water, Quack, Farm, Mallard, Animal, Feather)',
    '🦈': 'Shark (Ocean, Predator, Fish, Jaws, Sea, Fin, Animal, Water)',
    ...
    '🦒': 'Giraffe (Tall, Africa, Safari, Spots, Neck, Animal, Wildlife, Savanna)',
    '🦠': 'Microbe (Virus, Germ, Bacteria, Illness, Science, Bug, Infection, Health)',
    '🦥': 'Sloth (Slow, Lazy, Calm, Tree, Relax, Animal, Hang, Unhurried)',
    '🦴': 'Bone (Skeleton, Orthopedic, Anatomy, Calcium, Joint, Medical, Health, Fracture)',
    ...
    '🩸': 'Drop of Blood (Blood, Donate, Medical, Lab, Health, Plasma, Red Cross, Draw)',
    '🩹': 'Bandage (Injury, Hurt, Heal, First Aid, Cover)',
    '🩺': 'Stethoscope (Doctor, Listen, Heart, Medical, Check)',
    '🩻': 'X-Ray (Bone, Doctor, Scan, Medical, See)',
    '🩼': 'Crutch (Injury, Mobility, Recovery, Support, Cast, Walk, Medical, Aid)',
    ...
    '🪩': 'Mirror Ball (Disco, Party, Dance, Club, Nightlife, Sparkle, Ball, Entertainment)',
    ...
    '🫀': 'Anatomical Heart (Organ, Cardiac, Medical, Anatomy, Pulse, Cardiology, Health, Heart)',
    '🫁': 'Lungs (Breathing, Breath, Respiratory, Health, Wellness, Air)',
    '🫂': 'People Hugging (Hug, Friends, Support, Comfort, Community, Care, Embrace, Together)',
    ...
    '🫶': 'Heart Hands (Love, Appreciation, Thanks, Gesture, Kindness, Support, Affection, Social)',
